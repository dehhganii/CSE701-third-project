...
double ClosestPair::brute_force(vector<point> ps, uint64_t n)
{
    ...
    // The fixed size of the bmp file
    ...
    graphic.draw_point(Color(100, 0, 0), points[x1_ans].get_coordinates()[0], points[x1_ans].get_coordinates()[1]);
    graphic.draw_point(Color(100, 0, 0), points[x2_ans].get_coordinates()[0], points[x2_ans].get_coordinates()[1]);
